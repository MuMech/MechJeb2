...
namespace MechJebLib.PSG
{
    public readonly struct Problem
    {
        ...
        public Problem(V3 r0, V3 v0, V3 u0, double m0, double t0, double mu, double rbody, double h0, double rho0CdAref, double rho0InvQAlphaMax, V3 w, ITerminal terminal)
        {
        ...
        public Problem(Scale scale, V3 r0, V3 v0, V3 u0, double m0, double t0, double mu, double rbody, double h0, double rho0CdAref, double rho0InvQAlphaMax, V3 w, ITerminal terminal)
        {
            Scale            = scale;
            Mu               = mu;
            R0               = r0;
        ...
        public Problem WithoutQAlpha()
        {
            return new Problem(
                Scale, R0, V0, U0, M0, T0, Mu, RBody, H0, Rho0CdAref, 0, W, Terminal
            );
        }
    }
}
