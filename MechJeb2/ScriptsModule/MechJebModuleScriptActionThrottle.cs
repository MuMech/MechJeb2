...
namespace MuMech
{
    public class MechJebModuleScriptActionThrottle : MechJebModuleScriptAction //TODO: Experimental script module. Not working for the moment
    {
        ...
        public MechJebModuleScriptActionThrottle(MechJebModuleScript scriptModule, MechJebCore core, MechJebModuleScriptActionsList actionsList) :
        ...
        public override void activateAction()
        {
            ...
            {
                Vector3d target =
                    vessel.ReferenceTransform.InverseTransformDirection(new Vector3d(vessel.up.x * throttle, vessel.up.y * throttle,
                        vessel.up.z * throttle));
