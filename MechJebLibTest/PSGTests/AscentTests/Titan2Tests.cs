...
namespace MechJebLibTest.PSGTests.AscentTests
{
    public class Titan2Tests
    {
        ...
        public void FlightPathAngle4Elliptical()
        {
            ...
            Optimizer      psg      = ascent.GetOptimizer() ?? throw new Exception("null optimzer");
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.67772333454200362, 0.63259731440287881, 0.37484892907347683), 1e-3);
            solution.Vgo(0).ShouldEqual(9369.7098971395462, 1e-3);

            psg.PrimalFeasibility.ShouldBeZero(1e-6);
        ...
        public void FlightPathAngle3EnergyElliptical()
        {
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.68082115055327608, 0.63207119253936173, 0.37009264856408913), 1e-3);
            solution.Vgo(0).ShouldEqual(9369.7098971395462, 1e-3);
        ...
        public void FlightPathAngle5Elliptical()
        {
            ...
            psg.PrimalFeasibility.ShouldBeZero(1e-8);
            smaf.ShouldEqual(8616511.1913318466, 1e-7);
            eccf.ShouldEqual(0.23913520746130185, 1e-7);
            incf.ShouldEqual(incT, 1e-7);
        ...
        public void Kepler3Elliptical()
        {
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.67172175355893049, 0.64204627797572877, 0.36954899909650496), 1e-3);

            psg.PrimalFeasibility.ShouldBeZero(1e-7);
            smaf.ShouldEqual(8616511.1913318466, 1e-7);
            eccf.ShouldEqual(0.23913520746130185, 1e-7);
            incf.ShouldEqual(incT, 1e-7);
            lanf.ShouldEqual(Deg2Rad(270), 1e-2);
        ...
        public void Circular()
        {
            ...
            solution.R(0).ShouldEqual(r0, 1e-5);
            solution.V(0).ShouldEqual(v0, 1e-5);
            solution.M(0).ShouldEqual(157355.487476332, 1e-5);

            psg.PrimalFeasibility.ShouldBeZero(1e-5);
            solution.Vgo(0).ShouldEqual(8518.1366714811684, 1e-3);

            solution.U(0).normalized.ShouldEqual(new V3(0.69923636089452235, 0.60758017269333331, 0.37671586819899749), 1e-3);

            double aprf = Astro.ApoapsisFromKeplerian(smaf, eccf);
            double perf = Astro.PeriapsisFromKeplerian(smaf, eccf);

            perf.ShouldEqual(PeR, 1e-4);
            aprf.ShouldEqual(ApR, 1e-4);
            smaf.ShouldEqual(6556000, 1e-4);
            eccf.ShouldEqual(0, 1e-4);
            incf.ShouldEqual(incT, 1e-4);
            lanf.ShouldEqual(Deg2Rad(270), 1e-2);
