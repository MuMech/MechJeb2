...
namespace MuMech
{
    ...
    public class MechJebModuleInfoItems : ComputerModule
    {
        ...
        public string SuicideBurnCountdown()
        {
            ...
            double angleFromHorizontal = 90 - Vector3d.Angle(-vesselState.surfaceVelocity, vesselState.up);
            ...
            Vector3d estimatedLandingSite = vesselState.CoM + 0.5 * decelTime * vesselState.surfaceVelocity;
