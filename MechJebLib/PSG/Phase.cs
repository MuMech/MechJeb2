...
namespace MechJebLib.PSG
{
    public class Phase
    {
        ...
        public static Phase NewFixedCoast(double m0, double ct, int kspStage, int mjPhase, bool unguided=false)
        {
            return new Phase(m0, 0, double.PositiveInfinity, m0, ct, kspStage, mjPhase) { Unguided = unguided };
        }

        public static Phase NewOptimizedCoast(double m0, double mint, double maxt, int kspStage, int mjPhase, bool unguided=false)
        {
            var phase = new Phase(m0, 0, double.PositiveInfinity, m0, mint, kspStage, mjPhase) { AllowInfiniteBurntime = true, mint = mint, maxt = maxt, Unguided=unguided };
            return phase;
        }
