...
namespace MechJebLibTest.ControlTests
{
    public class PIDLoopTests
    {
        ...
        public void FirstOrderLagWithIntegrator()
        {
            ...
            {
                Kp = 2.10612233627086,
                Ki = 0.0358158912764876,
                Kd = 1.7003376306836,
                N  = 3.37809448105627,
                Ts = 0.02
            };

            pid.Kp.ShouldEqual(2.10612233627086);
            ...
            Assert.True(overshoot > 3.0 && overshoot < 10.0,
                $"Overshoot {overshoot:F2}% outside expected range [3%, 10%]. Expected ~4.2%");
        ...
        /// </summary>
        [Fact]
        public void FirstOrderLagWithIntegrator2()
        {
            // From Matlab with pidtune() to reference-tracking
