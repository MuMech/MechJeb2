...
namespace MechJebLibTest.ManeuversTests
{
    public class ReturnFromMoonTests
    {
        ...
        [Theory]
        [InlineData(3033960.04435434, -538512.74449519, -1569171.01639252, 344.550626047212, -973.108221764261, 907.813925253141)]
        ...
        [InlineData(1922287.76973033, 1688857.60199125, -1128186.04080648, -644.272529354446, 90.1035308326145, -74.2516010414118)]
        [InlineData(1448096.6091073, 2242802.60448088, 593799.176165359, 316.818652356425, -684.168486708854, -453.106628476226)]
        [InlineData(72567.8252483425, -1202508.27881747, 995820.818247795, 733.61121478193, -501.358138165138, -26.4032981481417)]
        [InlineData(1105140.06213014, -8431008.05414815, -4729658.84487529, -293.374690393787, -1173.3597686151, -411.755491683683)]
        public void NextManeuverToReturnFromMoonHard(double rx, double ry, double rz, double vx, double vy, double vz)
        {
            // this forces JIT compilation(?) of the SQL solver which takes ~250ms
            ChangeOrbitalElement.ChangePeriapsis(1.0, new V3(1, 0, 0), new V3(0, 1.0, 0), 1.0);
