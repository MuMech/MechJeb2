namespace MuMech
{
    public class OperationSemiMajor : Operation
    {
        ...
        public override ManeuverParameters MakeNodeImpl(Orbit o, double universalTime, MechJebModuleTargetController target)
        {
            ...
            {
                throw new OperationException("cannot make Semi-Major Axis less than twice the burn altitude plus the radius of " + o.referenceBody.bodyDisplayName + "(" + MuUtils.ToSI(o.referenceBody.Radius, 3) + "m)");
            }
