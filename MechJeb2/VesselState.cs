...
namespace MuMech
{
    public class VesselState
    {
        ...
        void UpdateVelocityAndCoM(Vessel vessel)
        {
            ...
            //MechJebCore.print("obt_vel " + MuUtils.PrettyPrint(vesselState.orbitalVelocity) + " vel " + MuUtils.PrettyPrint(velocity) + " delta " + MuUtils.PrettyPrint(vesselState.orbitalVelocity - velocity));
        }
