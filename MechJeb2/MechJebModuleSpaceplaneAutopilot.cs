...
namespace MuMech
{
    public class MechJebModuleSpaceplaneAutopilot : ComputerModule
    {
        ...
        {
            double targetClimbRate = (targetAltitude - vesselState.altitudeASL) / (30.0 * Math.Pow((RealMaxAtmosphereAltitude(mainBody) / (RealMaxAtmosphereAltitude(mainBody) - vesselState.altitudeASL)), 2));
