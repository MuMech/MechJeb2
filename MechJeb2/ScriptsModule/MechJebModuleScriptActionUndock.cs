...
namespace MuMech
{
    public class MechJebModuleScriptActionUndock : MechJebModuleScriptAction
    {
        ...
        public MechJebModuleScriptActionUndock(MechJebModuleScript scriptModule, MechJebCore core, MechJebModuleScriptActionsList actionsList) : base(
        ...
        public override void activateAction()
        {
            ...
            if (dockingPartsList[selectedPartIndex] != null)
            {
                ...
                {
                    scriptModule.setActiveBreakpoint(actionIndex, FlightGlobals.ActiveVessel);
