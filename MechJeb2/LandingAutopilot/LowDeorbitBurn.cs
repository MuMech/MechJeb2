...
namespace MuMech
{
    namespace Landing
    {
        ...
        {
            private bool   deorbitBurnTriggered;
            private double lowDeorbitBurnMaxThrottle;

            private bool lowDeorbitEndConditionSet;
            private bool lowDeorbitEndOnLandingSiteNearer;

            private const double lowDeorbitBurnTriggerFactor = 2;
