...
namespace MuMech
{
    public class PontryaginTest
    {
        ...
        public void centralForceThrustSimple()
        {
            ...
            Pontryagin.Arc a = new Pontryagin.Arc(ArcType.BURN, mdot: 63136.1585987428, thrust: 25092.0703945434);
            p.centralForceThrust(y, 0, dy, a);
        ...
        public void singleIntegrateComplex()
        {
            ...
            p.singleIntegrate(y0, yf, 0, ref t, 0.514092715632044, a);
        ...
        public void optimizationFunctionComplex()
        {
            ...
            Pontryagin p = new Pontryagin(r0: new Vector3d(1,0,0), v0: new Vector3d(0,1,0), m0: 32740);
            p.bcfun = (double[] yT, double[] zterm) => p.terminal5constraint(yT, zterm, rT, vT);
