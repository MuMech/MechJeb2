...
namespace MuMech
{
    public class MechJebModuleScriptActionRCS : MechJebModuleScriptAction
    {
        ...
        public MechJebModuleScriptActionRCS(MechJebModuleScript scriptModule, MechJebCore core, MechJebModuleScriptActionsList actionsList) : base(
        ...
        public override void activateAction()
        {
            ...
            else if (actionObject == 3)
            {
                if (actionType == 0)
                {
                    ...
                    {
                        errorMessage = "ERROR: Target is null";
                    }
                }
                else
                {
        ...
        public override void WindowGUI(int windowID)
        {
            ...
            {
                GUILayout.Label(errorMessage, GuiUtils.yellowLabel);
            }
